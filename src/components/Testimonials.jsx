  ...
  const testimonials = [
    {
      id: 1,
      image:
        "https://cdn.prod.website-files.com/6807e00032c9ff6c11834a8f/68091cde2ff066794554c24d_le%20host%20ceo.jpg",
    ...
    },
    {
      id: 2,
      image:
        "https://cdn.prod.website-files.com/6807e00032c9ff6c11834a8f/6807e00132c9ff6c11834c40_testi2.webp",
    ...
    <div className="min-h-screen bg-primary px-4 py-16 relative overflow-hidden">
      ...
      <div className="relative z-10 container mx-auto">
        <div className="text-center mb-12">
          <div className="inline-block bg-secondary text-black px-4 py-[5px] mx-auto rounded-full text-[.75rem] font-semibold uppercase tracking-wider mb-8">
            OUR TESTIMONIALS
          </div>
          <h1 className="text-3xl md:text-[48px] lg:text-[3.5rem] font-bold text-white mb-8 leading-tight lg:max-w-xl mx-auto">
            What Our Clients Say About Working with Skyrocket Business
          </h1>
          <p className="md:text-[18px] lg:text-[1.125rem] font-semibold text-white max-w-2xl mx-auto tracking-tightest mb-8">
        ...
        <div className="bg-white rounded-[24px] shadow-xl max-w-[83rem] md:p-8 mx-auto relative min-h-[350px] lg:min-h-[400px]">
          <div
            className={`flex flex-col lg:flex-row gap-6 h-full transition-opacity duration-500 ease-in-out ${
          ...
          >
            ...
            <div className="flex-1 flex flex-col p-8">
              ...
              <div className="flex-1 flex flex-col justify-center lg:justify-end">
                <p className="text-textColor text-[18px] lg:text-2xl font-medium mb-6 italic leading-relaxed">
                  "{currentData.quote}"
                </p>
              ...
              <div className="flex justify-center items-center gap-4 mt-10 lg:absolute lg:top-6 lg:right-10">
                <button
