        ...
        <div className="flex flex-col justify-center space-y-4 sm:space-y-5 md:space-y-6 order-2 lg:order-none">
          ...
          >
            <Link
              ...
              className="inline-flex items-center space-x-2 bg-secondary hover:bg-hoverColor text-textColor px-4 py-2 sm:px-5 sm:py-2.5 md:px-6 md:py-3 rounded-full transition-all duration-200 font-semibold text-sm sm:text-base"  // Faster transition
              onClick={() => {
            ...
            >
              ...
              <img
                ...
                className="h-3 w-3 sm:h-4 sm:w-4 transition-transform duration-200 group-hover:translate-x-1"  // Faster transition
              />
            </Link>
          </motion.div>
        </div>
